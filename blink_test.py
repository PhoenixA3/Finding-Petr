...
def start_blink_check():
    ...
    while (ret):
        ret, img = cap.read()
        # Converting the recorded image to grayscale + apply filter to remove impurities
...
start_button = tkinter.Button(root, text="Start Blink Check", padx=40, pady=20, command=lambda: start_blink_check())
